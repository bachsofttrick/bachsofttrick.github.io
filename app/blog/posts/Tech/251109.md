...
weighed over 9GB, need the exact version of [CUDA](https://hub.docker.com/r/nvidia/cuda) to the [CUDA](stackoverflow.com/questions/53422407/different-cuda-versions-shown-by-nvcc-and-nvidia-smi) on `nvidia-smi`,
...
- MarkusHoHo
```
Ah. I should have paid more pay attention to my Graphics class.
