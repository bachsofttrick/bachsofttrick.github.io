...
I asked what Claude Code is and how it [compresses](https://github.com/bachsofttrick/ocr-web/blob/main/compact.md) a conversation, it even came up with an [implementation](https://github.com/bachsofttrick/ocr-web/blob/main/claude-code-impl.md) with using local LLM and function calling. I'm not sure if that is how 
